...
{
    /**
     * The number of values made available from the DMM data.
     *
     * <p>
     * The typical scheme is:
     * <ul>
     * <li>value[0] is the main value.
     * <li>value[1] is the sub value.
     * </ul>
     *
     */

    // The Protek 506 only sends data for the main value (no sub value data).
    public final int valueCount = 1;
    public Value[] value = new Value[valueCount];

    public Integer barGraph = null;
    public final int barGraphMinimum = 0;
    public final int barGraphMaximum = 4000;
    ...
    public static class Value
    {
        ...
        public static class Unit
        {
             ...
             */
            private double convertDegreesCtoF(double temperature)
            {
                // °C = (°F - 32) x (5 / 9)
                // °F = °C x (9 / 5) + 32
        ...
        /**
         * Gets a more accurate representation what the value looks like on the Protek 506 LCD including whitespace padding, etc.
         *
         * This also includes non-numerical values (i.e. words on LCD like "Shrt", "OPEn").
         *
    ...
    /**
     * Annunciators are modes or options that the Protek 506 DMM can have enabled or disabled.
     *
